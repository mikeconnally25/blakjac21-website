...
export const BOT_REPLY_FIELDS = [
  ...
  {
    key: "stakePromo",
    label: "Stake promo (every 10 min)",
    group: "Promo",
    description: "Posted automatically to Kick chat about every 10 minutes.",
  },
  {
    key: "kycDiscordPromo",
    label: "KYC / Discord promo (every 15 min)",
    group: "Promo",
    description: "Posted automatically to Kick chat about every 15 minutes.",
  },
  {
    key: "commandsList",
...
export const DEFAULT_BOT_REPLIES = {
  ...
  stakePromo:
    "Sign up on Stake.com today! https://stake.com/?offer=blakjac21&c=c52feb0e28",
  kycDiscordPromo:
    "Need a kyc'd for stake account? Make a ticket in !discord for more information.",
